...
namespace DBS.Migrations
{
    ...
    [Migration("20240412062052_Revenue")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.DriverRevenue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Data.Entities.RevenueDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<long>("DriverIncome")
                        .HasColumnType("bigint");

                    b.Property<Guid>("DriverRevenueId")
                        .HasColumnType("uuid");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("boolean");

                    b.Property<long>("SystemIncome")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Data.Entities.RevenueDetail", b =>
                {
                    ...
                    b.HasOne("Data.Entities.DriverRevenue", "DriverRevenue")
                        .WithMany()
                        .HasForeignKey("DriverRevenueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Booking");

                    b.Navigation("DriverRevenue");
                });
